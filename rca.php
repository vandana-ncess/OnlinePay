  ...
  <div id="border">
    <div id="main">
      ...
      <div align="center" id="right" style="width:970px;height:auto;">
          <div class="ser" align="left" style=" padding-left:100px;"><h1>RCA</h1>
          	<form action="" method="post">
            	<table align="left" id="tblSer"  style="width:970px;height:80px;">
                    ...
                    <tr>
                     ...
                     <tr>
                       <td>RCA Sanction Details</td><td><textarea name="txtDetails" id="txtDetails" rows="3" style="width:250px;" required></textarea></td>
          ...
          <script type="text/javascript">
		  	function loadLabel()
			{
				if(document.getElementById('ddlCategory').value != 'NCESS')
					...
					document.getElementById('tblSer').rows[8].cells[0].innerHTML = "RCA Sanction Details";
			}
		  </script>
      </div>
      <div class="clear"></div>
