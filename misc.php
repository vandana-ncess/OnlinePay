  ...
  <div id="border">
    <div id="main">
      ...
      <div align="center" id="right" style="width:970px;height:auto;">
          <div class="ser" align="left" style=" padding-left:100px;"><h1>Miscellaneous Services</h1>
          	<form action="" method="post">
            	<table align="left" id="tblSer"  style="width:970px;height:80px;">
                    ...
                    <tr>
                        <td >Service Name</td><td><input type="text" name="" required txtAmountid="txtAmount" style="width:250px;" /></td>
                        <td colspan="2">Amount to be paid &nbsp;&nbsp;&nbsp;<input type="text" name="" required txtAmountid="txtAmount" style="width:80px;" /></td>
					</tr>
                
                     <tr>
                     	<td >Service Details Details</td><td><textarea name="txtDetails" id="txtDetails" rows="3" style="width:250px;" required></textarea></td>
                       <td style="width:130px;">Remarks</td> <td ><textarea name="txtRemarks" id="txtRemarks" rows="3" style="width:250px;"> </textarea></td>
                    </tr>
