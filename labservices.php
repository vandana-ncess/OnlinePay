    ...
    <div id="main">
      ...
      <div align="center" id="right" style="width:970px;height:400px;">
       ...
       <div class="content" style="width:970px;"><br />
          <div align="left" style="background-image:url(images/services.gif); background:no-repeat;width:970px;padding-left:100px;"><h2></h2></div>
          <?php
          	 ...
          	 <table align="center" cellpadding="10" cellspacing="10" id="services" style="width:700px;padding-left:20px;">
  						...
  						<tbody style="color:#333" align="left">
							...
							?>	  
                                	...
                                	<td bgcolor="#3333FF">  <?php if($data[4] == 'complex') echo "<a href ='Lab_Template_Complex.php?labID=" .  $data[0] . " ' >" . $data[1] . "</a>"; else echo "<a href ='Lab_Template.php?labID=" .  $data[0] . " ' >" . $data[1] . "</a>"; ?> 
                                    <input type="hidden" id="txtLabID"  <?php echo "value = " . $data[0]; ?> /><input type="hidden" name="txtSampSize"  <?php echo "value = " . $data[0]; ?> 
                                    </td>
