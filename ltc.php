  ...
  <div id="border">
    <div id="main">
      ...
      <div align="center" id="right" style="width:970px;height:auto;">
          <div class="ser" align="left" style=" padding-left:100px;"><h1>LTC</h1>
          	<form action="" method="post">
            	<table align="left" id="tblSer"  style="width:970px;height:80px;">
                    ...
                    <tr>
                    	<td>Sanction No.</td><td><input type="text" name="txtDetails" id="txtDetails" rows="3" style="width:250px;" required /></td>
